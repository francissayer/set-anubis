...
def main():
    ...
    def compute_mu_heatmaps():
        ...
        pattern = str(folder / 'selection_cutflow_*_decay_channel_MATHUSLA200.csv')
        ...
        for br in br_vals:
            ...
            out_csv = os.path.join(args.output_dir, f'Simulated_MATHUSLA200_higgs_signal_events_data_mumu_BR_{str(br).replace(".","p")}.csv')
            ...
            out_png = os.path.join(args.output_dir, f'Simulated_MATHUSLA200_signal_events_heatmap_mumu_BR_{str(br).replace(".","p")}.png')
            plot_heatmap(mass_vals_grid, caphi_vals_grid, heat_sig, out_png,
                         title=(f'Simulated MATHUSLA200 Expected Signal Events (mumu), BR_mu={br}, mass={args.mass} GeV'),
