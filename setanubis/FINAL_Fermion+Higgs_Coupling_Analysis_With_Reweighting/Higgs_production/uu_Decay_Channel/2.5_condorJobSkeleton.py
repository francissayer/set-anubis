...
EXTRACT_SCRIPT = "/usera/fs568/set-anubis/setanubis/FINAL_Z_Analysis_With_Reweighting/Higgs_production/uu_Decay_Channel/2_extract_selection_data.py"
...
for coup_pos, target_coup in enumerate(target_couplings, start=1):
    ...
    jobDir = os.path.join(jobscriptDir, f"job{job_counter}_c{coup_pos}_Higgs_uu")
