...
files and write per-run selection summaries to CSV for the ``cc`` decay
channel.
...
Outputs
-------
The script writes a CSV (default: ``selection_cutflow_cc_decay_channel.csv``)
...
DEFAULT_BUNDLE_DIR = "/raid/anubis/sensitivityStudyData/ALPs/fermionCoupled/Higgs_to_ALP_Z_FINAL_Default_Lifetime_With_Reweighting/cc_Decay_Channel"
DEFAULT_OUTDIR = "/usera/fs568/set-anubis/setanubis/FINAL_Z_Analysis_With_Reweighting/Higgs_production/cc_Decay_Channel"
DEFAULT_OUTPUT = "selection_cutflow_cc_decay_channel.csv"
