...
files and write per-run selection summaries to CSV for the ``tata`` decay
channel.
...
Outputs
-------
The script writes a CSV (default: ``selection_cutflow_tata_decay_channel.csv``)
...
DEFAULT_BUNDLE_DIR = "/raid/anubis/sensitivityStudyData/ALPs/fermionCoupled/Higgs_to_ALP_Z_FINAL_Default_Lifetime_With_Reweighting/tata_Decay_Channel"
DEFAULT_OUTDIR = "/usera/fs568/set-anubis/setanubis/FINAL_Z_Analysis_With_Reweighting/Higgs_production/tata_Decay_Channel"
DEFAULT_OUTPUT = "selection_cutflow_tata_decay_channel.csv"
...
PROCESS_INDEX = 1
DECAY_CHANNEL_INDEX = 3

# Default CaPhi coupling scan used when --target-couplings is not provided
DEFAULT_TARGET_COUPLINGS = [1.0,0.794,0.631,0.501,0.398,0.316,0.251,0.200,0.158,0.126,
                            0.1,0.0794,0.0631,0.0501,0.0398,0.0316,0.0251,0.0200,0.0158,0.0126,
                            0.01,0.00794,0.00631,0.00501,0.00398,0.00316,0.00251,0.00200,0.00158,0.00126,
                            0.001,0.000794,0.000631,0.000501,0.000398,0.000316,0.000251,0.000200,0.000158,0.000126,
                            0.0001,0.0000794,0.0000631,0.0000501,0.0000398,0.0000316,0.0000251,0.0000200,0.0000158,0.0000126,
                            0.00001,0.00000794,0.00000631,0.00000501,0.00000398,0.00000316,0.00000251,0.00000200,0.00000158,0.00000126,
                            0.000001,0.000000794,0.000000631,0.000000501,0.000000398,0.000000316,0.000000251,0.000000200,0.000000158,0.000000126,
                            0.0000001,0.0000000794,0.0000000631,0.0000000501,0.0000000398,0.0000000316]
