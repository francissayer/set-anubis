...
DF_FILE = ("/usera/fs568/set-anubis/ALP_Z_df_Scan_32_Run_17.pkl")
...
if __name__ == "__main__":
    ...
    save_bundle(out_opt, "ALP_Z_sampledfs_Scan_32_Run_17.pkl.gz")     # Want to save the sample dataframes for use in selection pipeline
