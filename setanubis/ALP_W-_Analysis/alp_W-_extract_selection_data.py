...
def extract_scan_run_from_filename(filename: str) -> tuple:
    ...
    Example: 'ALP_W-_sampledfs_Scan_3_Run_4.pkl.gz' -> (3, 4)
    """
...
def find_bundle_files(directory: str, pattern: str = "ALP_W-_sampledfs_*.pkl.gz") -> List[str]:
...
Examples:
  ...
  python extract_selection_data.py --output my_selection_data.csv
    ...
    ap.add_argument(
        ...
        help="Directory containing bundle files (default: /usera/fs568/set-anubis/ALP_W-_Runs)"
    )
    ap.add_argument(
        "--bundle-files",
        nargs="+",
    ...
    ap.add_argument(
        "--pattern",
        default="ALP_W-_sampledfs_*.pkl.gz",
        help="File pattern to match (default: ALP_W-_sampledfs_*.pkl.gz)"
    )
    ap.add_argument(
        "--sel-mode",
        default="standard",
    ...
    ap.add_argument(
        "--output",
        default="selection_cutflow_data_Wminus.csv",
        help="Output CSV filename (default: selection_cutflow_data_Wminus.csv)"
    )
    ap.add_argument(
        "--outdir",
