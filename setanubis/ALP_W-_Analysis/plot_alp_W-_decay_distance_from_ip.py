...
def plot_individual_distributions(data_dict_list, output_dir, caphi, use_log=True):
    ...
    output_path = os.path.join(output_dir, 'alp_distance_ip_Wminus_individual.pdf')
...
def plot_overlay_distribution(data_dict_list, output_dir, caphi, use_log=True):
    ...
    output_path = os.path.join(output_dir, 'alp_distance_ip_Wminus_overlay.pdf')
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
...
def plot_statistics_vs_mass(data_dict_list, output_dir, caphi):
    ...
    output_path = os.path.join(output_dir, 'alp_distance_ip_Wminus_vs_mass.pdf')
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
