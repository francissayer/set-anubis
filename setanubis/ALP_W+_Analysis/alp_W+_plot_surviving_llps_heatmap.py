...
Plot heat map of surviving LLPs vs mass and coupling CaPhi.
    ...
    This script reads the selection_cutflow_data_Wplus.csv file and creates a 2D heat map
...
def plot_multiple_views(mass_vals, caphi_vals, heatmap_data, heatmap_weighted, output_dir, df):
    ...
    plot_heatmap(mass_vals, caphi_vals, heatmap_data,
                os.path.join(output_dir, 'surviving_llps_heatmap_Wplus.png'),
    ...
    plot_heatmap(mass_vals, caphi_vals, heatmap_weighted,
                os.path.join(output_dir, 'surviving_llps_heatmap_weighted_log_Wplus.png'),
    ...
    plot_heatmap(mass_vals, caphi_vals, heatmap_weighted,
                os.path.join(output_dir, 'surviving_llps_heatmap_weighted_linear_Wplus.png'),
                title='Surviving LLPs (Weighted) vs Mass and Coupling (pp → W+ + ALP)',
    ...
    plot_heatmap(mass_vals, caphi_vals, efficiency_data,
                os.path.join(output_dir, 'surviving_llps_efficiency_Wplus.png'),
...
def main():
    ...
    parser.add_argument(
        '--csv', 
        type=str, 
        default='/usera/fs568/set-anubis/setanubis/selection_cutflow_data_Wplus.csv',
