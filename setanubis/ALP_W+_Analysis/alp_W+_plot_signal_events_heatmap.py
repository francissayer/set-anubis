...
Signal event calculation:
    ...
    plot_heatmap(
        ...
        os.path.join(args.output_dir, 'signal_events_heatmap_Wplus.png'),
    ...
    plot_heatmap(
        ...
        os.path.join(args.output_dir, 'acceptance_heatmap_Wplus.png'),
    ...
    plot_heatmap(
        ...
        os.path.join(args.output_dir, 'cross_section_heatmap_Wplus.png'),
