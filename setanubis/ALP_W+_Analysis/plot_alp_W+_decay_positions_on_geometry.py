...
def main():
    ...
    xy_path = os.path.join(args.output_dir, 'alp_decays_geometry_Wplus_xy.pdf')
    plot_geometry_with_decays_xy(plotter, decay_data_list, xy_path, args.caphi)
    
    # XZ view (side view along x)
    xz_path = os.path.join(args.output_dir, 'alp_decays_geometry_Wplus_xz.pdf')
    plot_geometry_with_decays_xz(plotter, decay_data_list, xz_path, args.caphi)
    
    # ZY view (side view along z/beamline)
    zy_path = os.path.join(args.output_dir, 'alp_decays_geometry_Wplus_zy.pdf')
